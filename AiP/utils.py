...
def update_search_history(history_frame: Frame, search_history: List[Dict]):
    ...
    Label(history_frame, text="История поиска:", font=("Arial", 12, "bold")).pack(anchor="w")
    for book in search_history:
        Label(history_frame, text=f"{book['title']} — {book['authors']}", font=("Arial", 10)).pack(anchor="w")
